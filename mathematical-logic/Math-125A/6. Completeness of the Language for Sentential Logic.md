...
> Begin by noticing that for any WFF, we can use the truth assignment rules previously defined to write out a truth table that shows all possible truth assignments on the variable symbols and the resulting .
